...
%  was ihr braucht
\begin{frame}[fragile]
\frametitle{was brauche ich?}
 \begin{semiverbatim}
    \uncover<1->{ im gleichen ordner eine datei}
    \uncover<1->{ an entsprechenden stellen ein \\cite\{...\} }
    \uncover<1->{ kapitel quellen: \\bibliography\{alpha\} und .. }
  \end{semiverbatim}
...
%     \begin{semiverbatim}
%     \begin{itemize}
%       \item Im \textbf{gleichen} Ordner die Datei
%       \item an den stellen dann  \\cite{...}
%       \item da wo die quellen hinsollen ein \\bibliographystyle{alpha}  und ein \\bibliography{name\_der\_datenbank}
%     \end{itemize}
%     \end{semiverbatim}
\end{frame}
...
%     \item { \bibliographystyle{alpha}}}
%     \text{\bibliography{name_der_datenbank}}
